<?php
namespace Shipping\DeliveryDate\Model;
...
class Config
{
    const XPATH_FORMAT                 = 'shipping_deliverydate/general/format';
    const XPATH_DISABLED               = 'shipping_deliverydate/general/disabled';
    const XPATH_HOURMIN                = 'shipping_deliverydate/general/hourMin';
    const XPATH_HOURMAX                = 'shipping_deliverydate/general/hourMax';
    const XPATH_REQUIRED_DELIVERY_DATE = 'shipping_deliverydate/general/required_delivery_date';
