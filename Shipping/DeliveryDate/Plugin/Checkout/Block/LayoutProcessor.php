<?php
namespace Shipping\DeliveryDate\Plugin\Checkout\Block;

use Shipping\DeliveryDate\Model\Config;

class LayoutProcessor
{
    /**
     * @var \Shipping\DeliveryDate\Model\Config
     */
    protected $config;
    ...
    public function afterProcess(
        ...
        ['shippingAddress']['children']['shippingAdditional'] = [
            ...
            'children' => [
                'delivery_date' => [
                    'component' => 'Shipping_DeliveryDate/js/view/delivery-date-block',
                    ...
                    'children' => [
                        'form-fields' => [
                            ...
                            'children' => [
                                'delivery_date' => [
                                    'component' => 'Shipping_DeliveryDate/js/view/delivery-date',
                                    'config' => [
                                        'customScope' => 'delivery_date',
                                        'template' => 'ui/form/field',
                                        'elementTmpl' => 'Shipping_DeliveryDate/fields/delivery-date',
                                        'options' => [],
                                        'id' => 'delivery_date',
